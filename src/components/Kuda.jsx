...
function Kuda() {
  return (
    <div className="kuda-mobile--get">
      <div className="Kuda-ratings ">
        <div className="flex items-center">
          <div className="kuda-app--badge">
          ...
          <div className="kuda-app--stars">
            <p className="kuda-app--name card-main--heading no-margin--bottom text-xbold color-primary">
              Kuda.
            </p>
            <div className="kuda-star--wrap">
        ...
        <a
          ...
          className="kuda-cta kuda_web kuda-a"
...
// customer <details></details> first last email password(hashed) permission
// police generator id name policy name policy decription time stamp policy type active
// data rentention data-source-name data-source-id location decription data-type deletion-period retention-period email-address incompliance(boolian)
// dsar name request-type decription email date active(bool) managed-by
