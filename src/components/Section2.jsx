          ...
          <div className="card card-item">
            <div className="card-icon--spacing mb-[15px]">
              <svg width="37" height="38" viewBox="0 0 37 38" fill="none">
                <circle cx="18.5" cy="18.7012" r="18.5" fill="#DFE3FF"></circle>
                <path
                  d="M12.8999 18.6749C12.8999 15.596 15.3958 13.1001 18.4747 13.1001C21.5535 13.1001 24.0495 15.596 24.0495 18.6749C24.0495 21.7537 21.5535 24.2497 18.4747 24.2497C15.3958 24.2497 12.8999 21.7537 12.8999 18.6749Z"
                  fill="white"
                ></path>
                <path
                  d="M9.40039 25.0443H14.2003V20.2443H12.2231L12.223 18.2877H18.0623V22.4003L16.0793 22.4003V27.2002H20.8791V22.4003H18.9168L18.9111 18.2877H24.7504L24.7503 20.2444H22.7582V25.0443H27.558V20.2444H25.5957L25.5957 17.3705H18.9111V15.0001H20.8867V10.2002H16.0868V15.0001H18.0623V17.3705H11.3776L11.3777 20.2443H9.40039V25.0443Z"
                  fill="#40196D"
                ></path>
              </svg>
            </div>
